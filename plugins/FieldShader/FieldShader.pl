package MT::Plugin::Editing::OMV::FieldShader;
...
<__trans phrase="Enable to toggle shading of the fields.">
HTMLHEREDOC
    ...
    registry => {
        ...
        applications => {
            cms => {
                methods => {
                    save_filed_shader_prefs => "${FULLNAME}::Methods::save_filed_shader_prefs",
                },
            },
        },
    },
